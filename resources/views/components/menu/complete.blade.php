...
<head>
    ...
    <meta http-equiv="refresh" content="5;url={{ route('customer.index') }}">
...
<body>
    <div class="flip-in-ver-right flex items-center justify-center h-screen">
        <div class="text-center">
            ...
            <p class="mb-5 text-gray-600 mt-2">Please proceed to the cashier for payment, Page will redirect in 5s</p>
    </div>
</body>
</html>
