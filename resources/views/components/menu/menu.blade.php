            ...
            @foreach($menus as $menu)
                <div class="card-link hover:shadow-lg swing-in-top-fwd">
                    <div class="relative bg-white rounded-lg shadow-md">
                        ...
                        <form action="{{ route('menu.checkout', $menu->id) }}" method="post">
                            @csrf
                            ...
                            <button type="submit" class="absolute bottom-4 right-4 text-black  hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
