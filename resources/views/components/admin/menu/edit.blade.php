            ...
            <div class="card-body">
                ...
                <form action="{{ route('menu.update', $menu->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" rows="3">{{ $menu->getDescription() }}</textarea> <!-- end Snow-editor-->
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ $menu->price }}" name="price" type="text" class="form-control" id="product-price" placeholder="Enter amount">
                    </div>
